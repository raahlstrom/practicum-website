...
export const content = {
  mission: {
    statement: "We help schools prevent the loss of academic progress that occurs as students move through the K-12 system, by launching Scholarship Granting Organizations that support students across every transition.",
  },

  vision: {
    statement: "Every student's progress endures across every transition of their education, from kindergarten through graduation.",
  },

  weBelieve: {
    specLabel: "We Believe",
    paragraphs: [
  ...
  whoWeAre: {
    ...
    mandates: [
      {
        label: "First",
        body: "We help educators and institutions stand up SGOs designed to prevent the loss of academic progress. We do not prescribe specific interventions; we require a theory of change. Whether an organization focuses on early literacy, vocational readiness, or continuity of support across moves, the activities must be grounded in evidence and the outcomes must be measurable.",
      },
      {
        label: "Second",
        body: "We advocate at the policy level for SGOs to be used in service of measurable outcomes for low-income students. The federal mechanism will be shaped by early implementation. We intend to shape it toward impact.",
      },
    ],
    closing: "Over time, we will develop a certification model: a seal that signals to donors, families, and policymakers that an SGO operates with a credible theory of change and rigorous accountability. The mechanism is powerful. The theory is what makes it work.",
  },

  ourModel: {
    specLabel: "Our Model",
    intro: "SGOs are a powerful funding mechanism without a default theory of use. The law permits much more than most SGOs deliver, which creates three problems:",
    problems: [
    ...
    logicModelIntro: "We start from the impact we are trying to produce and work backward:",
    levels: [
      {
        label: "Impact",
        body: "Students retain and compound their academic progress across every transition of their K-12 education, graduating ready to participate civically, economically, and socially in their communities.",
      },
      {
        label: "Outcomes",
        body: "Students retain the gains they make across moves, school changes, and grade transitions. Losses at the points where they are most predictable, and most damaging, are reduced.",
      },
      {
        label: "Outputs",
        body: "We help educators determine what to measure, including grade-level reading proficiency, vocational completion, continuity of services, and student-level progress across transitions.",
      },
      {
        label: "Activities",
        body: "We help educators define the specific activities their SGO will undertake, grounded in evidence about what helps students retain and build on their learning. Activities are context-specific; the theory linking them to outcomes is not optional.",
      },
      {
        label: "Inputs",
        body: "We help educators identify the resources their SGO needs, including the federal tax-credit funding mechanism, institutional partnerships, and the operational capacity to sustain the work.",
      },
    ],
  },
};
